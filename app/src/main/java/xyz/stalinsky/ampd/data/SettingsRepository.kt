...
object SettingsSerializer : Serializer<Settings> {
    override val defaultValue: Settings = Settings.getDefaultInstance().toBuilder()
        .addTabs(Settings.Tab.newBuilder().setEnabled(true).setType(Settings.TabType.TAB_TYPE_ARTISTS))
        .addTabs(Settings.Tab.newBuilder().setEnabled(true).setType(Settings.TabType.TAB_TYPE_ALBUMS))
        .build()
